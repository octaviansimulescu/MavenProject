...
public class IsSelectedExample extends BaseTest {
    ...
    public void isSelectedTest() throws InterruptedException {
       driver.findElement(By.cssSelector("li[class='menu_user+login']>a[href='popup_login']"));

        WebElement username = driver.findElement(By.cssSelector("div[class='form-left] input[id='log'"));
    ...
    }//li[class='menu_user+login']>a[href='popup_login']



    //div>input[id='rememberme']
}
