...
public class XpathExample3 extends BaseTest{
    ...
    public void xpathExample3() {
        ...
        //--> atunci cand vreau ultimul element dar nu sa ma bazez pe index folosim last()
        //(//h2[@class='woocommerce-loop-product__title'])[last()-1]
        //h2[@class='woocommerce-loop-product__title'])[last()]
